...
async function getPosts() {
  const res = await fetch(
    `${BLOG_URL}/ghost/api/v3/content/posts/?key=${CONTENT_API_KEY}&fields=title,slug,feature_image,custom_excerpt,reading_time,created_at&include=authors, tags`
  ).then((res) => res.json());
    ...
    <>
      ...
      <div className={styles.container} style={{ marginTop: "10rem" }}>
        <section className="blog_area section-margin">
          {/* <div className="container">
            <div className="row">
              <div className="col-lg-12 mb-5 mb-lg-0">
                <div className="blog_left_sidebar"></div>
              </div>
            </div>
          </div> */}
          ...
          {posts.map((post) => {
            return (
              <article className="blog_item" key={post.slug}>
